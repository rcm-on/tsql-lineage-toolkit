...
- **El enriquecimiento con planes de ejecución no cierra ese hueco hoy.** Medido sobre el First Responder Kit: casa los 7 procedimientos y descubre 906 aristas, pero **el 60 % son tablas temporales, el 36 % estructuras internas de SQL Server y ninguna es una tabla de negocio**. La razón es el corpus: el FRK es tooling de DBA y su SQL dinámico ataca DMVs, no tablas de aplicación. Para saber si la pieza vale hace falta un corpus donde el SQL dinámico apunte a tablas de usuario.
